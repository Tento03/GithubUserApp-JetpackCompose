...
@Composable
fun SearchScreen(navController: NavController,username:String, userViewModel: UserViewModel= hiltViewModel(),
...
@Composable
fun SearchCard(item: Item,onClick :()->Unit,modifier: Modifier = Modifier) {
