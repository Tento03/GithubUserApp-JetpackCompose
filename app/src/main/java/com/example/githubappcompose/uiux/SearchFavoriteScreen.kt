...
import com.example.githubappcompose.favorite.Favorite
import com.example.githubappcompose.favorite.FavoriteViewModel

@Composable
fun SearchFavoriteScreen(navController: NavController,username:String, favoriteViewModel: FavoriteViewModel= hiltViewModel(),
               modifier: Modifier = Modifier) {
    val searchUser by favoriteViewModel.searchFavorite.collectAsState()
    var q=username
    favoriteViewModel.searchFavorite(q)
...
@Composable
fun SearchFavoriteCard(item: Favorite,onClick :()->Unit,modifier: Modifier = Modifier) {
